...
export default {
  ...
  // Button
  btnFontFamily: (Platform.OS === 'ios') ? 'Futura' : 'Roboto_medium',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: (Platform.OS === 'ios' ) ? '#23b7e5' : '#4179F7',


  //FooterTab
  tabBarTextColor: (Platform.OS === 'ios' ) ? '#ffffff' : '#b3c7f9',
  tabBarActiveTextColor: (Platform.OS === 'ios' ) ? '#ffffff' : '#fff',

  //Tab
  tabDefaultBg: (Platform.OS === 'ios' ) ? '#23b7e5' : '#4179F7',
  ...
  toolbarDefaultBg: (Platform.OS === 'ios' ) ? '#23b7e5' : '#4179F7',
